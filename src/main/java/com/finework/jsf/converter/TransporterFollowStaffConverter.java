...
@ManagedBean(name = TransporterFollowStaffConverter.CONTROLLER_NAME)
@RequestScoped
public class TransporterFollowStaffConverter implements Converter {
    
    private static final Logger LOG = Logger.getLogger(TransporterFollowStaffConverter.class);
    public static final String CONTROLLER_NAME = "transporterFollowStaffConverter";
    ...
    public Object getAsObject(FacesContext fc, UIComponent component, String value) {
        ...
        try {
                if(value != null &&  value.trim().length() > 0  && !"null".equals(value)) {
                    ...
                    criteria.setTransportstaffType(Constants.TRANSPORT_FOLLOW_STAFF);
