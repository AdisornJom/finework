...
@Named(B112Controller.CONTROLLER_NAME)
@SessionScoped
public class B112Controller extends BaseController {

    private static final Logger LOG = Logger.getLogger(B112Controller.class);
    public static final String CONTROLLER_NAME = "b112Controller";
...
//            }
            ...
            //insert Billinge
            selected.setBillingType(Constants.BILLING_B112);
    ...
    public void reportPDF() {
         ...
         */
           // map.put("bill_date",DateTimeUtil.cvtDateForShow(rpt_sysDelivery.getBillDateLast(), "dd/MM/yyyy", new Locale("th", "TH")));
            ...
            map.put("reportCode", "B112");
            //report.exportSubReport("b112", new String[]{"B112Report","B112SubReport"}, "B112", map, reportList_);
            report.exportSubReport_Heading("delivery_bill.png","b112", new String[]{"B112Report","B112SubReport"}, "B112", map, reportList_); 
        } catch (Exception ex) {
            JsfUtil.addFacesErrorMessage(MessageBundleLoader.getMessage("messages.code.9001"));
            LOG.error(ex);
        }
...
public void printPdfMuti(){
             ...
             for (SysBilling sysBilling : printSelected) {
                ...
                */
                   // map.put("bill_date",DateTimeUtil.cvtDateForShow(rpt_sysbilling.getBillDateLast(), "dd/MM/yyyy", new Locale("th", "TH")));
                    ...
                    map.put("reportCode", "B112");
                   // JasperPrint print= report.exportSubReport_Template_mearge("template.jpg","b112", new String[]{"B112Report","B112SubReport"}, "B112", map, reportList_);
                    JasperPrint print= report.exportSubReport_Template_mearge_heading("delivery_bill.png","b112", new String[]{"B112Report","B112SubReport"}, "B112", map, reportList_);
    ...
    public void search() {
        try {
             ...
             items=billingFacade.findSysBillingListByCriteria(Constants.BILLING_B112,documentno,companyName,startDate,toDate);
//             lazyBillingModel = new LazyBillingDataModel(billingFacade,Constants.BILLING_B1112,documentno,StringUtils.trimToEmpty(companyName),startDate,toDate);
 ...
 //Auto Complete==========================================================================  
   ...
   public List<SysCustomer> completeCustomer(String query) {
    ...
    public void runningNoCustomer() {
        String sequence_no=sequence.updateRunningNO(1,Constants.SEQUNCE_NO_B112,"yyMM");
