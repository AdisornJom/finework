...
@Named(B103Controller.CONTROLLER_NAME)
@SessionScoped
public class B103Controller extends BaseController {

    private static final Logger LOG = Logger.getLogger(B103Controller.class);
    public static final String CONTROLLER_NAME = "b103Controller";
...
//        
//        try {
//             items=billingFacade.findSysBillingList(Constants.BILLING_ACC);
//        } catch (Exception ex) {
//            LOG.error(ex);
//        }
    search();
...
//        runningNoCustomer();
    ...
    public void create() {
      try {
            ...
            //insert Billinge
            selected.setBillingType(Constants.BILLING_ACC);
            ...
            selected.setBillTotal(total_detail);
            selected.setBillVat(Double.valueOf(new DecimalFormat("##.00").format(total_detail*0.07)));
            selected.setBillTotalPrice(selected.getBillTotal()+selected.getBillVat());
            
//            //update running no.
//             String sequence_no=sequence.updateRunningNO(null,Constants.SEQUNCE_NO_ACC);
//             selected.setDocumentno(sequence_no);
    ...
    public void search() {
        try {
            ...
            // items=billingFacade.findSysBillingListByCriteria(Constants.BILLING_ACC,null,companyName,startDate,toDate);
            lazyBillingModel = new LazyBillingDataModel(billingFacade,Constants.BILLING_ACC,null,StringUtils.trimToEmpty(companyName),startDate,toDate);
 ...
 //Auto Complete==========================================================================  
   ...
   public List<SysCustomer> completeCustomer(String query) {
     ...
     public void runningNoCustomer() {
        String sequence_no=sequence.updateRunningNO(1,Constants.SEQUNCE_NO_ACC,"yyMM");
