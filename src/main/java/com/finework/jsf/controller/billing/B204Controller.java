...
@Named(B204Controller.CONTROLLER_NAME)
@SessionScoped
public class B204Controller extends BaseController {

    private static final Logger LOG = Logger.getLogger(B204Controller.class);
    public static final String CONTROLLER_NAME = "b204Controller";
...
//            }
            ...
            //insert Billinge
            selected.setBillingType(Constants.CREDIT_NOTE);
    ...
    public void reportPDF() {
        try {
           ...
           // map.put("price_total",NumberUtils.numberFormat(rpt_sysbilling.getRealTotalPrice(),"#,##0.00"));
            ...
            map.put("reportCode", "B204");
            report.exportSubReport_Template("template.jpg","b204", new String[]{"B204Report","B204SubReport"}, "Credit_Note", map, reportList_);
         ...
         try {
             ...
             for (SysBilling sysBilling : printSelected) {
                   ...
                   // map.put("price_total",NumberUtils.numberFormat(rpt_sysbilling.getRealTotalPrice(),"#,##0.00"));
                    ...
                    map.put("reportCode", "B204");
                   JasperPrint print= report.exportSubReport_Template_mearge("template.jpg","b204", new String[]{"B204Report","B204SubReport"}, "Credit_Note", map, reportList_);
...
//                    billingFacade.createSysPrintBilling(sysPrintBilling);
    ...
    public void search() {
        try {
           ...
           //  items=billingFacade.findSysBillingListByCriteria(Constants.CREDIT_NOTE,documentno,StringUtils.trimToEmpty(companyName),startDate,toDate);
              items=billingFacade.findSysBillingListByCriteria(Constants.CREDIT_NOTE,documentno,StringUtils.trimToEmpty(cust_find.getCustomerNameTh()),startDate,toDate);
 ...
 //Auto Complete==========================================================================  
   ...
   public List<SysCustomer> completeCustomer(String query) {
    ...
    public void runningNoCustomer() {
        String sequence_no=sequence.updateRunningNO(1,Constants.SEQUNCE_NO_B204,"yyMM");
        this.selected.setDocumentno(sequence_no);
    } 
