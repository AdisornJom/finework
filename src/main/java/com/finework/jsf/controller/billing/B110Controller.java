...
@Named(B110Controller.CONTROLLER_NAME)
@SessionScoped
public class B110Controller extends BaseController {

    private static final Logger LOG = Logger.getLogger(B110Controller.class);
    public static final String CONTROLLER_NAME = "b110Controller";
...
//            }
            ...
            //insert Billinge
            selected.setBillingType(Constants.BILLING_B110);
...
//            }
         ...
         try {
             ...
             for (SysBilling sysBilling : printSelected) {
                   ...
                   // map.put("bill_date",DateTimeUtil.cvtDateForShow(rpt_sysDelivery.getBillDateLast(), "dd/MM/yyyy", new Locale("th", "TH")));
                    ...
                    map.put("reportCode", "B110");
                    JasperPrint print= report.exportSubReport_Template_mearge("template.jpg","b110", new String[]{"B110Report","B110SubReport"}, "B110", map, reportList_);
    ...
    public void search() {
        try {
             ...
             items=billingFacade.findSysBillingListByCriteria(Constants.BILLING_B110,documentno,companyName,startDate,toDate);
         ...
         try {
             //validate field iteam 
              if (detail_selected==null
                    ...
                    ||dvDetail_selected.getSendDate()==null
