...
@Named(B201Controller.CONTROLLER_NAME)
@SessionScoped
public class B201Controller extends BaseController {

    private static final Logger LOG = Logger.getLogger(B201Controller.class);
    public static final String CONTROLLER_NAME = "b201Controller";
...
//        try {
//             items=billingFacade.findSysBillingList(Constants.BILLING_GOOD_RECEIPT);
//        } catch (Exception ex) {
//            LOG.error(ex);
//        }
...
/*
    ...
    public void search() {
        try {
             ...
             items=billingFacade.findSysBillingListByCriteria(Constants.BILLING_GOOD_RECEIPT,documentno,StringUtils.trimToEmpty(companyName),startDate,toDate);
//             lazyBillingModel = new LazyBillingDataModel(billingFacade,Constants.BILLING_GOOD_RECEIPT,documentno,StringUtils.trimToEmpty(companyName),startDate,toDate);
