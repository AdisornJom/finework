...
@Named(B105Controller.CONTROLLER_NAME)
@SessionScoped
public class B105Controller extends BaseController {

    private static final Logger LOG = Logger.getLogger(B105Controller.class);
    public static final String CONTROLLER_NAME = "b105Controller";
    ...
    private SysHousePlan housePlan_selected;
...
//        runningNoCustomer();
    ...
    public void clearData(){
         ...
         housePlan_selected=new SysHousePlan();
    ...
    public void create() {
      try {
            ...
            //insert Billinge
            selected.setBillingType(Constants.BILLING_B105);
            selected.setCustomerId(cust_selected);
            selected.setWorkunitId(workunit_selected);
            selected.setHousePlanId(housePlan_selected);
...
//            //update running no.
//             String sequence_no=sequence.updateRunningNO(null,Constants.SEQUNCE_NO_B105);
//             selected.setDocumentno(sequence_no);
    ...
    public void reportPDF() {
        try {
          ...
          //  reportList.add(new BillingReportBean("", "", selected.getHousePlanId().getDetailDesc(), "", "", "", "", "",""));
            ...
            map.put("houseplan",null!=rpt_sysDelivery.getHousePlanId().getDetailDesc()?rpt_sysDelivery.getHousePlanId().getDetailDesc():"-");
            map.put("nursery",null!=rpt_sysDelivery.getNursery()?selected.getNursery():"-");
    ...
    public void printPdfMuti(){
         try {
             ...
             for (SysBilling sysBilling : printSelected) {
                    ...
                    map.put("houseplan",null!=rpt_sysbilling.getHousePlanId().getDetailDesc()?rpt_sysbilling.getHousePlanId().getDetailDesc():"-");
                    map.put("nursery",null!=rpt_sysbilling.getNursery()?rpt_sysbilling.getNursery():"-");
    ...
    public void search() {
        try {
               ...
               items=billingFacade.findSysBillingListByCriteria(Constants.BILLING_B105,documentno,companyName,startDate,toDate);
 //            lazyBillingModel = new LazyBillingDataModel(billingFacade,Constants.BILLING_B105,documentno,StringUtils.trimToEmpty(companyName),startDate,toDate);
 ...
 //Auto Complete==========================================================================  
   ...
   public List<SysWorkunit> completeWorkunit(String query) {
    ...
    public List<SysDetail> completeDetail(String query) {
       ...
       try {
            List<SysDetail> allSysDetail = stockFacade.findSySDetailListByHousePlan((null==housePlan_selected.getDetailId())?0:housePlan_selected.getDetailId(),"Y");
 ...
 //End Auto Complete==========================================================================   
  ...
  //Auto complete housePlan
   public List<SysHousePlan> completeHousePlan(String query) {
    ...
    public SysHousePlan getHousePlan_selected() {
        return housePlan_selected;
    }

    public void setHousePlan_selected(SysHousePlan housePlan_selected) {
        this.housePlan_selected = housePlan_selected;
    }
