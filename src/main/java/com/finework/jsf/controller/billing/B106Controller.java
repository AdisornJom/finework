...
@Named(B106Controller.CONTROLLER_NAME)
@SessionScoped
public class B106Controller extends BaseController {

    private static final Logger LOG = Logger.getLogger(B106Controller.class);
    public static final String CONTROLLER_NAME = "b106Controller";
...
//        runningNoCustomer();
    ...
    public void create() {
      try {
            ...
            //insert Billinge
            selected.setBillingType(Constants.BILLING_B106);
        ...
        try {
            ...
            for (SysBillingDetail to : list) {
               ...
               // bean.setHouseNo(null!=to.getHouseNo()?to.getHouseNo():"");
                bean.setHouseNo(null!=selected.getNursery()?selected.getNursery():"");
         ...
         try {
             ...
             for (SysBilling sysBilling : printSelected) {
                   ...
                   // map.put("bill_date",DateTimeUtil.cvtDateForShow(rpt_sysbilling.getBillDateLast(), "dd/MM/yyyy", new Locale("th", "TH")));
                    ...
                    map.put("reportCode", "B106");
                    JasperPrint print= report.exportSubReport_Template_mearge("template.jpg","b106", new String[]{"B106Report","B106SubReport"}, "B106", map, reportList_);
    ...
    public void search() {
        try {
             ...
             items=billingFacade.findSysBillingListByCriteria(Constants.BILLING_B106,documentno,companyName,startDate,toDate);
//             lazyBillingModel = new LazyBillingDataModel(billingFacade,Constants.BILLING_B106,documentno,StringUtils.trimToEmpty(companyName),startDate,toDate);
