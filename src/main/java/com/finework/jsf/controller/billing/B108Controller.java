...
@Named(B108Controller.CONTROLLER_NAME)
@SessionScoped
public class B108Controller extends BaseController {

    private static final Logger LOG = Logger.getLogger(B108Controller.class);
    public static final String CONTROLLER_NAME = "b108Controller";
...
//            }
            ...
            //insert Billinge
            selected.setBillingType(Constants.BILLING_B108);
...
public void printPdfMuti(){
    ...
    public void search() {
        try {
             ...
             items=billingFacade.findSysBillingListByCriteria(Constants.BILLING_B108,documentno,companyName,startDate,toDate);
//             lazyBillingModel = new LazyBillingDataModel(billingFacade,Constants.BILLING_B108,documentno,StringUtils.trimToEmpty(companyName),startDate,toDate);
