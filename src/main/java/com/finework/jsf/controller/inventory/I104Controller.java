 ...
 * @author Adisorn j.
 */
@ManagedBean(name = I104Controller.CONTROLLER_NAME)
@SessionScoped
public class I104Controller extends BaseController {

    private static final Logger LOG = Logger.getLogger(I104Controller.class);
    public static final String CONTROLLER_NAME = "i104Controller";
