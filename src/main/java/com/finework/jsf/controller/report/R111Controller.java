...
@ManagedBean(name = R111Controller.CONTROLLER_NAME)
@SessionScoped
public class R111Controller extends BaseController {

    private static final Logger LOG = Logger.getLogger(R111Controller.class);
    public static final String CONTROLLER_NAME = "r111Controller";
...
//        runningNoCustomer();
    ...
    public void search() {
        try {
              ...
              items=manufactoryFacade.findSysManufactoryListRealByCriteria(documentno, null,null,foreman_selected, startDate, toDate);
