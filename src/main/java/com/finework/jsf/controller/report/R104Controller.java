...
@ManagedBean(name = R104Controller.CONTROLLER_NAME)
@SessionScoped
public class R104Controller extends BaseController {

    private static final Logger LOG = Logger.getLogger(R104Controller.class);
    public static final String CONTROLLER_NAME = "r104Controller";
...
//         this.dialog_toDate=null;
    ...
    public void search() {
        try {
              ...
              items=paymentManufactoryFacade.findSysPaymentManufactoryOverDrawListByCriteria(documentno, contractor_find, startDate, toDate);
