...
@ManagedBean(name = R110Controller.CONTROLLER_NAME)
@SessionScoped
public class R110Controller extends BaseController {

    private static final Logger LOG = Logger.getLogger(R110Controller.class);
    public static final String CONTROLLER_NAME = "r110Controller";
    ...
    //
    private List<SysManufactoryDetail> items;
...
//        runningNoCustomer();
    ...
    public void search() {
        try {
              ...
              items=manufactoryFacade.findSysManufactoryListByWorkunit(workunit_selected, startDate, toDate);
...
//            billingFacade.createSysPrintBilling(sysPrintBilling);
    ...
    public List<SysManufactoryDetail> getItems() {
        return items;
    }

    public void setItems(List<SysManufactoryDetail> items) {
        this.items = items;
    }
