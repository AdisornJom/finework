...
@ManagedBean(name = R105Controller.CONTROLLER_NAME)
@SessionScoped
public class R105Controller extends BaseController {

    private static final Logger LOG = Logger.getLogger(R105Controller.class);
    public static final String CONTROLLER_NAME = "r105Controller";
