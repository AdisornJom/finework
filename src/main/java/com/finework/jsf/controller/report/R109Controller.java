...
@ManagedBean(name = R109Controller.CONTROLLER_NAME)
@SessionScoped
public class R109Controller extends BaseController {

    private static final Logger LOG = Logger.getLogger(R109Controller.class);
    public static final String CONTROLLER_NAME = "r109Controller";
...
//        runningNoCustomer();
    ...
    public void search() {
        try {
            ...
            Double totalSum = 0.0;
            for(SysManufactory sysManufactory:items){
                totalSum=totalSum+sysManufactory.getTotal();
            }
...
//             dataTable.setFirst(0);
    ...
    public void checkTotalPrice(){
        ...
        if (null != selected.getSysManufactoryRealList()) {
            for (SysManufactoryReal sysManufactoryReal : selected.getSysManufactoryRealList()) {
