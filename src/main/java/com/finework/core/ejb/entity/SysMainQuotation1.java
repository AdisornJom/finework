...
@XmlRootElement
@NamedQueries({
    @NamedQuery(name = "SysMainQuotation1.findAll", query = "SELECT s FROM SysMainQuotation1 s")})
public class SysMainQuotation1 implements Serializable {
    ...
    public int hashCode() {
        int hash = 0;
        hash += (quotation1Id != null ? quotation1Id.hashCode() : 0);
        return hash;
    }
    ...
    public String toString() {
        return "com.finework.core.ejb.entity.SysMainQuotation1[ quotation1Id=" + quotation1Id + " ]";
    }
