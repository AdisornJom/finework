...
public class JsfUtil
{
  ...
  public static Object resolveMethodExpression(String expression, Class returnType, Class[] argTypes, Object[] argValues)
  {
    ...
    MethodExpression methodExpression = elFactory
      .createMethodExpression(elContext, expression, returnType, argTypes);
  ...
  public static FacesMessage getMessageFromBundle(String key, FacesMessage.Severity severity)
  {
    ...
    String detail = getStringSafely(bundle, new StringBuilder().append(key).append("_detail").toString(), summary);
  ...
  private static String getStringSafely(ResourceBundle bundle, String key, String defaultValue)
  {
    ...
    try {
      ...
      if (defaultValue != null)
        ...
        resource = new StringBuilder().append("Missing resource: ").append(key).toString();
      }
    }
    return resource;
  }
  ...
  public static String getPageURL(String view)
  {
    ...
    String targetPageUrl = view.startsWith("/") ? view : new StringBuilder().append("/").append(view).toString();
