...
public class CreateJobBO {
    ...
    public List<SysCreatejob> findSysCreatejobListByCriteria(SysForeman foremanId,String documentno,SysWorkunit workunitId,Integer status,Date startDate, Date toDate, int[] range) throws Exception {
        List<SysCreatejob> sysBilling = sysCreateJobDAO.findSysCreatejobListByCriteria(foremanId,documentno,workunitId,status, startDate, toDate,range);
    ...
    public int countSysCreatejobListByCriteria(SysForeman foremanId,String documentno,SysWorkunit workunitId,Integer status,Date startDate, Date toDate) throws Exception {
       return sysCreateJobDAO.countSysCreatejobListByCriteria(foremanId,documentno,workunitId,status, startDate, toDate);
    }

    public void createSysCreateJob(SysCreatejob sysCreatejob) throws Exception{
        sysCreateJobDAO.create(sysCreatejob);
    }
    
    public void editSysCreateJob(SysCreatejob sysCreatejob) throws Exception{
        sysCreateJobDAO.edit(sysCreatejob);
    }
