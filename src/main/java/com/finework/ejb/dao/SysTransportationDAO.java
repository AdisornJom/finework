...
public class SysTransportationDAO extends AbstractDAO<SysTransportation>
{
  ...
  {
    Query q = this.em.createQuery("select o from SysTransportation o order by  o.transportId asc");
    return q.getResultList();
  }

  public SysTransportation findSysTransportationById(Integer transportId) {
    Query q = this.em.createQuery("select o from SysTransportation o where o.transportId =:transportId ");
