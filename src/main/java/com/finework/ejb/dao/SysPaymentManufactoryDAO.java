...
public class SysPaymentManufactoryDAO extends AbstractDAO<SysPaymentManufactory> {
    ...
    public SysPaymentManufactory findSysPaymentManufactoryById(Integer paymentFactoryId) {
        Query q = em.createQuery("select o from SysPaymentManufactory o where o.paymentFactoryId =:paymentFactoryId");
    ...
    public List<SysPaymentManufactory> findSysPaymentManufactoryList() {
        Query q = em.createQuery("select o from SysPaymentManufactory o  order by o.paymentFactoryId DESC");
    ...
    public List<SysPaymentManufactory> findSysPaymentManufactoryR106List(Date startDate, Date toDate, int[] range) throws Exception {
     ...
     try {
            ...
            return (result == null) ? BigDecimal.ZERO : new BigDecimal(result);
    ...
    public List<ReportR105TO> findReportR105List(Integer contractorId, Date dateFrom, Date dateTo) throws Exception {
        ...
        if (dateFrom != null) {
            sb.append(" and a.payment_startdate >= '").append(DateTimeUtil.dateToString(dateFrom, DateTimeUtil.PATTERN_DT_DB)).append("'");
        }
        if (dateTo != null) {
            sb.append(" and a.payment_enddate <= '").append(DateTimeUtil.dateToString(dateTo, DateTimeUtil.PATTERN_DT_DB)).append("'");
        }
        sb.append(" group by b.contractor_name_th,b.contractor_nickname");
        Query q = em.createNativeQuery(sb.toString(), ReportR105TO.class);
        return q.getResultList();
    }
     ...
     public List<ReportR105TO> findReportR105List(Integer contractorId, Date dateFrom, Date dateTo, int[] range) throws Exception {
        ...
        if (dateFrom != null) {
            sb.append(" and a.payment_startdate >= '").append(DateTimeUtil.dateToString(dateFrom, DateTimeUtil.pattern1)).append("'");
        }
        if (dateTo != null) {
            sb.append(" and a.payment_enddate <= '").append(DateTimeUtil.dateToString(dateTo, DateTimeUtil.pattern1)).append("'");
        }
        sb.append(" group by b.contractor_name_th,b.contractor_nickname");
