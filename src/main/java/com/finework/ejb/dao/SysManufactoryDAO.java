...
public class SysManufactoryDAO extends AbstractDAO<SysManufactory> {
    ...
    public SysManufactory findSysManufactoryById(Integer factoryId) {
        Query q = em.createQuery("select o from SysManufactory o where o.factoryId =:factoryId order by  factoryId desc");
    ...
    public List<SysManufactory> findSysManufactoryList() {
        Query q = em.createQuery("select o from SysManufactory o  order by o.factoryId DESC");
    ...
    //paymentType 1=normal, 2=payment
